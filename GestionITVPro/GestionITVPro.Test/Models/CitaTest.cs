...
public class CitaTest {
    ...
    public class CasosPositivos {
        ...
        public void ToString_DeberiaRetonarFormatoCorrecto() {
            ...
            resultado.Should().Contain("Cita"); // Sin tilde y sin corchetes
        ...
        public void Descripcion_DeberiaConcatenarMatriculaMarcaModeloYMotor() {
            // Arrange
            var vehiculo = new Cita { Matricula = "1234-CDF", Marca = "BMW",  Modelo = "M-4", Motor =  Motor.Gasolina};
        ...
        public void Equals_MismaMatricula_DeberiaSerIgual() {
            var vehiculo1 = new Cita { Matricula = "1234-CDF", Marca = "BMW",};
            var vehiculo2 = new Cita  { Matricula = "1234-CDF", Marca = "BMW",};
        ...
        public void Equals_DistintaMatricula_DeberiaNoSerIgual() {
            var vehiculo = new Cita { Matricula = "1234-CDF", Marca = "BMW",};
            var vehiculo2 = new Cita  { Matricula = "1234-CDN", Marca = "BMW",};
        ...
        public void GetHashCode_MismaMatricula_MismoHashCode() {
            // Arrange
            var vehiculo =  new Cita { Matricula = "1234-CDF" };
            var vehiculo2 = new Cita { Matricula = "1234-CDF" };
